export default function Home() {
  return (
    <>
      ...
      >
        {/* Eyebrow */}
        <p className="text-xs font-semibold tracking-[0.3em] uppercase text-violet-400">
          Available for hire
        </p>

        {/* Value proposition headline */}
        <h1 className="max-w-3xl text-5xl sm:text-6xl lg:text-7xl font-bold leading-[1.1] tracking-tight">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-2">
          ...
          <a
            href="/about"
            className="px-8 py-3 rounded-lg border border-zinc-700 hover:border-zinc-500 text-zinc-300 hover:text-zinc-100 font-semibold transition-colors"
          >
            Learn More
          </a>
        </div>
